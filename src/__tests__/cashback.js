...
test.each([
  ...
  ['regular', 1000, 10],
  ['no', 500, 0],
  // В Jest вы можете использовать %i для подстановки целочисленных значений, %s для подстановки строковых значений и %f для подстановки значений с плавающей запятой из входных данных
